...
> **版本**: v0.1.2 | **日期**: 2026-02-23 | **分支**: master
...
| 变更 | 说明 |
|------|------|
| **#57 修复** | Windows daemon fork 立即退出问题 |
| **#119** | 统一配置抽象: AgentTemplate 继承 VersionedComponent |
| **#118 修复** | Template loader 丢失 schedule/permissions/plugins 字段 |
| **初始化管线** | 新增 InitializationPipeline: 支持 5 种步骤类型, 超时, 回滚 |
| **Source 管理** | 新增 SourceManager: GitHub/Local 组件源, Preset 系统 |
...
| **#120** | Windows: 自定义 ACTANT_HOME 时 Daemon/CLI IPC 路径不匹配 |
