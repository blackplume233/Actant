---
id: 215
title: "feat: REST API 流式聊天 + RPC 并发 multiplexing"
status: closed
labels:
  - feature
  - "priority:P1"
...
relatedIssues:
  ...
  - 214
relatedFiles:
  - packages/rest-api/src/routes/agents.ts
  - packages/rest-api/src/rpc-bridge.ts
  - packages/dashboard/client/src/pages/agent-chat.tsx
  - packages/dashboard/client/src/lib/api.ts
  - packages/rest-api/src/routes/webhooks.ts
  - packages/daemon/src/rpc/
  - packages/shared/src/types/
taskRef: null
githubRef: "blackplume233/Actant#215"
closedAs: null
createdAt: "2026-02-26T21:40:00"
updatedAt: "2026-03-18T06:38:51"
closedAt: "2026-03-18T06:36:19Z"
---

**Related Issues**: [[0213]], [[0214]]
**Related Files**: `packages/rest-api/src/routes/agents.ts`, `packages/rest-api/src/rpc-bridge.ts`, `packages/dashboard/client/src/pages/agent-chat.tsx`, `packages/dashboard/client/src/lib/api.ts`, `packages/rest-api/src/routes/webhooks.ts`, `packages/daemon/src/rpc/`, `packages/shared/src/types/`

---

**Related Issues**: [[0213-rpc-error-http-status-mapping]], [[0214-webhook-undefined-error-and-hanging]]
**Related Files**: `packages/rest-api/src/routes/agents.ts`, `packages/rest-api/src/rpc-bridge.ts`, `packages/dashboard/client/src/pages/agent-chat.tsx`
...
---
_Synced from `.trellis/issues` (local ID: 215)_

**Author:** cursor-agent
**Related files:** `packages/rest-api/src/routes/agents.ts`, `packages/rest-api/src/rpc-bridge.ts`, `packages/dashboard/client/src/pages/agent-chat.tsx`, `packages/dashboard/client/src/lib/api.ts`, `packages/rest-api/src/routes/webhooks.ts`, `packages/daemon/src/rpc/`, `packages/shared/src/types/`
**Related local issues:** #213, #214
