...
updatedAt: "2026-03-18T06:38:23"
closedAt: "2026-03-18T06:35:08Z"
---

**Related Issues**: [[0137-runtime-mcp-manager]], [[0016]], [[0040]], [[0014]], [[0122]], [[0136-agent-to-agent-email]], [[0173-epic-plugin-actant-agent]]
...
---
_Synced from `.trellis/issues` (local ID: 178)_

**Author:** human
**Related files:** `packages/acp/src/connection.ts`, `packages/mcp-server/src/index.ts`, `packages/core/src/domain/mcp/mcp-config-manager.ts`
**Related local issues:** #137, #16, #40, #14, #122, #136, #173
