...
updatedAt: "2026-03-18T06:38:14"
closedAt: "2026-03-18T06:34:51Z"
---

**Related Issues**: [[0133-actant-env-var-default-provider-config]]
**Related Files**: `packages/shared/src/types/template.types.ts`, `packages/core/src/template/schema/template-schema.ts`, `packages/core/src/template/schema/config-validators.ts`, `packages/cli/src/commands/setup/steps/configure-provider.ts`, `packages/core/src/manager/agent-manager.ts`, `packages/core/src/manager/launcher/backend-registry.ts`, `packages/core/src/manager/launcher/builtin-backends.ts`, `packages/api/src/services/app-context.ts`, `packages/pi/src/acp-bridge.ts`, `.trellis/spec/config-spec.md`
...
---
_Synced from `.trellis/issues` (local ID: 141)_

**Author:** human
**Related files:** `packages/shared/src/types/template.types.ts`, `packages/core/src/template/schema/template-schema.ts`, `packages/core/src/template/schema/config-validators.ts`, `packages/cli/src/commands/setup/steps/configure-provider.ts`, `packages/core/src/manager/agent-manager.ts`, `packages/core/src/manager/launcher/backend-registry.ts`, `packages/core/src/manager/launcher/builtin-backends.ts`, `packages/api/src/services/app-context.ts`, `packages/pi/src/acp-bridge.ts`, `.trellis/spec/config-spec.md`
**Related local issues:** #133
