...
echo "[1/6] Bootstrap host status"
...
standalone_out="$(ACTANT_SOCKET=/tmp/actant-bootstrap-smoke-missing.sock run packages/mcp-server/src/index.ts </dev/null 2>&1 || true)"
echo "$standalone_out"
