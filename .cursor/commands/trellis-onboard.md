...
**[2/4] bash ./.trellis/scripts/task.sh create "Planning task" --slug planning-task** - Planning is valuable work
...
```bash
bash ./.trellis/scripts/task.sh create "Fill spec guidelines" --slug fill-spec-guidelines
```
