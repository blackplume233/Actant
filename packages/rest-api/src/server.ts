...
function generateOpenApiSummary(version: string): object {
  return {
    ...
    paths: {
      ...
      "/catalogs": {
        get: { summary: "List catalogs", tags: ["Catalogs"] },
        post: { summary: "Add catalog", tags: ["Catalogs"] },
      },
      "/catalogs/{name}": { delete: { summary: "Remove catalog", tags: ["Catalogs"] } },
      "/catalogs/{name}/sync": { post: { summary: "Sync catalog", tags: ["Catalogs"] } },
      "/catalogs/{name}/validate": { post: { summary: "Validate catalog", tags: ["Catalogs"] } },
      "/presets": { get: { summary: "List presets", tags: ["Catalogs"] } },
      "/presets/{name}": { get: { summary: "Show preset", tags: ["Catalogs"] } },
      "/presets/{name}/apply": { post: { summary: "Apply preset", tags: ["Catalogs"] } },
      "/sessions": {
