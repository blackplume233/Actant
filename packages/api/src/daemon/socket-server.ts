...
const ERROR_CODE_MAP: Record<string, number> = {
  ...
  SESSION_VALIDATION_ERROR: RPC_ERROR_CODES.INVALID_PARAMS,
  SESSION_NOT_FOUND: RPC_ERROR_CODES.AGENT_NOT_FOUND,
  SESSION_EXPIRED: RPC_ERROR_CODES.GENERIC_BUSINESS,
  ACP_CONNECTION_MISSING: RPC_ERROR_CODES.GENERIC_BUSINESS,
  AGENT_NOT_RUNNING: RPC_ERROR_CODES.AGENT_ALREADY_RUNNING,
  GATEWAY_UNAVAILABLE: RPC_ERROR_CODES.GENERIC_BUSINESS,
  CANCEL_FAILED: RPC_ERROR_CODES.GENERIC_BUSINESS,
};
