...
This directory is a local issue/discussion cache.
...
- GitHub issue state is authoritative for issue lifecycle
- local issue files may explain scope and context, but should not override roadmap/spec
- historical references should stay in issues, not leak back into active truth docs
