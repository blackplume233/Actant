...
updatedAt: "2026-03-18T06:38:52"
closedAt: "2026-03-18T06:36:21Z"
---

**Related Issues**: [[0193]], [[0122]], [[0171]]
**Related Files**: `packages/api/src/routes/agent-routes.ts`, `packages/core/src/acp/acp-connection-manager.ts`, `packages/shared/src/types/agent.types.ts`, `packages/dashboard/client/src/pages/agents.tsx`
...
---
_Synced from `.trellis/issues` (local ID: 219)_

**Author:** human
**Milestone:** near-term
**Related files:** `packages/api/src/routes/agent-routes.ts`, `packages/core/src/acp/acp-connection-manager.ts`, `packages/shared/src/types/agent.types.ts`, `packages/dashboard/client/src/pages/agents.tsx`
**Related local issues:** #193, #122, #171
