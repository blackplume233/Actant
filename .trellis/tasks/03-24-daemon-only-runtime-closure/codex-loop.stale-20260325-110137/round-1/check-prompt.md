...
- Requirement: Remove createStandaloneProjectContextRuntime usage, remove CLI hub and MCP standalone fallback, remove PluginHost and related runtime plugin surfaces, delete physical packages/context residue, and keep bridge access strictly RPC -> daemon.
- Round: 1 / 3
