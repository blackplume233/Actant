...
| 22 | agent status rw-agent-1 (after stop) | PASS | status: stopped |
| 23 | restart flow (start + stop) | **PASS** | R11 为 WARN，本次改善：start 成功 |
| 24 | agent stop rw-agent-1 | **PASS** | R11 为 WARN，本次改善 |
...
| 37 | agent list | WARN | 表仅显示 1 个（期望 3），与 R11 一致 |
