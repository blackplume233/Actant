...
> **版本**: v0.1.0 | **生成时间**: 2026-02-22T00:22:08.415Z
...
| `create` | — | Create a new agent from a template | `<name>` | `--launch-mode <mode>`, `--work-dir <path>`, `--overwrite`, `--append`, `-f, --format <format>`, `-t, --template <template>` * |
