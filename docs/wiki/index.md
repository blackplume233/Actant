...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: GitHub
      link: https://github.com/blackplume233/Actant
...
features:
  ...
  - icon: 🏪
    title: 组件生态
    details: 从 GitHub/本地同步组件，Preset 一键应用，团队共享 Agent 配方。
---

<!-- GENERATED: 本 Wiki 全部内容为自动生成，仅供人类用户阅读。
     AI Agent 请勿将此作为开发或操作参考。
     AI 权威源：.trellis/spec/ · docs/stage/ · 源码本身。 -->
